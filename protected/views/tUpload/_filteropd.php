                ...
                <?php $form=$this->beginWidget('CActiveForm', array(
                        ...
                        <div class="row">                   
                                <?php
                                        ...
                                        $kategoriAll= TUpload::model()->findAllByAttributes(array('upload_status'=>3),array('with'=>array('uploadOpd'),'condition'=>'uploadOpd.opd_wil=:wil','params'=>array(':wil'=>Yii::app()->user->getWilayah())));
                    ...
                    <div class="row">
                                ...
                                <?php //echo $form->textField($model,'upload_ket',array('class'=>'form-control')); ?>
