...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Daftar Laporan Kesalahan Bukti Belum Lengkap / Masih Ada Kesalahan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-6">
                      <?php echo CHtml::link('<i class="fas fa-filter"></i>   Opsi Filter','#',array('class'=>'search-button btn btn-outline-info')); ?>
                        ...
                        <?php $this->renderPartial('_filteropdb',array(
                                'model'=>$model,
                        )); ?>
                        </div>
