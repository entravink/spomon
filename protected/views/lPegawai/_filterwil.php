                ...
                <?php $form=$this->beginWidget('CActiveForm', array(
                        ...
                        <div class="row">                   
                                <?php
                                        $kategoriAll=array();
                                        $kategori=array();
                                        $kategoriAll= MOpd::model()->findAllByAttributes(array('opd_wil'=>Yii::app()->user->getWilayah(),'is_aktif'=>1),array('order'=>'opd_nama',));
                                ...
                                <?php
                                      echo $form->dropDownList($model,'pegawai_opd',$kategori,array('empty'=>'--Pilih Instansi--','class'=>'form-control',));
                                ?>
                        </div>
